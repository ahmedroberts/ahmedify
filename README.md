Ahmed Music Streaming

This is a starter project for a music streaming app using ExpressServer [Express Server JS](https://github.com/expressjs/expressjs.com).
...
1. Run `devStart`. This is a script that starts nodemon
...
## Dependencies
* MongoDB must be running and linked in the environmental variables DATABASE_URL
